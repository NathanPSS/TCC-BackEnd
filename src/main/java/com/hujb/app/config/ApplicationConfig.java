...
public class ApplicationConfig {
    ...
    public ApplicationConfig(EstagiariosRepository estagiariosRepository) {
        this.estagiariosRepository = estagiariosRepository;
    }

    @Bean
    public UserDetailsService userDetailsService(){
        return username -> estagiariosRepository.findByUsername(username).orElseThrow(() -> new UsernameNotFoundException("Estagiario Não Encontrado"));
